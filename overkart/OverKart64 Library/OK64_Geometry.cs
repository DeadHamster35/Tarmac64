...
namespace OverKart64
{
    public class OK64
    {
        ...
        public string F3DEX_Model(byte commandbyte, byte[] segment, byte[] seg4, int vertoffset, int segmentoffset)
        {
            ...
            if (commandbyte == 0xB1)
            {
                for (int i = 0; i < 2; i++)
                {
                    ...
                    ///
                    seg4r.BaseStream.Seek(vertoffset + (indexA * 16), SeekOrigin.Begin);
                    ...
                    ///
                    seg4r.BaseStream.Seek(vertoffset + (indexB * 16), SeekOrigin.Begin);
                    ...
                    ///
                    seg4r.BaseStream.Seek(vertoffset + (indexC * 16), SeekOrigin.Begin);
            ...
            if (commandbyte == 0x04)
            {
                ...
                mainsegr.BaseStream.Seek(segmentoffset+3, SeekOrigin.Begin);
                byte[] rsp_add = mainsegr.ReadBytes(4);
        ...
        public OK64Texture[] loadTextures(AssimpSharp.Scene fbx)
        {
            ...
            {
                textureArray[materialIndex] = new OK64.OK64Texture();

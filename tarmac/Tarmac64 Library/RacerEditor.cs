...
namespace Tarmac64
{
    ...
    public partial class RacerEditor : Form
    {
        ...
        private void Aj_TextChanged(object sender, KeyEventArgs e)
        {

        }

        private void Ai_TextChanged(object sender, KeyEventArgs e)
        {

        }

        private void Ah_TextChanged(object sender, KeyEventArgs e)
        {

        }

        private void Ag_TextChanged(object sender, KeyEventArgs e)
        {

        }

        private void Af_TextChanged(object sender, KeyEventArgs e)
        {

...
namespace Tarmac64_Library.Controls
{
    public partial class CourseSettings : UserControl
    {
        ...
        public int LoadCourseSettings(string[] SettingsInfo)
        {
            ...
            CourseData.WaterType = Convert.ToInt32(SettingsInfo[ThisLine++]);
        ...
        public string[] SaveCourseSettings()
        {
            ...
            Output.Add(CourseData.WaterType.ToString());
        ...
        public void UpdateCourse()
        {
            ...
            CourseData.WaterType = WaterTypeBox.SelectedIndex;
        ...
        public void UpdateUI()
        {
            ...
            WaterTypeBox.SelectedIndex = CourseData.WaterType;
